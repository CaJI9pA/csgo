...
#define TAG_CHAT 								"[Урон] - "
#define PLUGIN_VERSION							"1.0.0"
#define MAX_TYPE_WEAPONS						12
...
public void OnPluginStart()
{
	...
	AutoExecConfig_SetFile("show_damage", "sourcemod");
	
	AutoExecConfig_CreateConVar("show_damage_version", PLUGIN_VERSION, "Version", CVARS);
	
	cvar_active_show_damage 					= AutoExecConfig_CreateConVar("active_show_damage",  				"1", 					"Enable/Disable Show Damage", 		DEFAULT_FLAGS, 		true, 0.0, 		true, 1.0);
	cvar_active_show_damage_dev					= AutoExecConfig_CreateConVar("active_show_damage_dev", 			"0", 					"Enable/Disable Show Damage Dev", 	DEFAULT_FLAGS, 		true, 0.0, 		true, 1.0);
	
	cvar_show_damage_sniper_time				= AutoExecConfig_CreateConVar("show_damage_sniper_time", 			"0.5", 					"SNIPERS Time Between shots", 		DEFAULT_FLAGS);
	cvar_show_damage_mg_time					= AutoExecConfig_CreateConVar("show_damage_mg_time", 				"0.5", 					"MGuns Time Between shots", 		DEFAULT_FLAGS);
	cvar_show_damage_rifle_time					= AutoExecConfig_CreateConVar("show_damage_rifle_time", 			"0.5", 					"RIFLES Time Between shots", 		DEFAULT_FLAGS);
	cvar_show_damage_mp_time					= AutoExecConfig_CreateConVar("show_damage_mp_time", 				"0.5", 					"MPs Time Between shots", 			DEFAULT_FLAGS);
	cvar_show_damage_pump_time					= AutoExecConfig_CreateConVar("show_damage_pump_time", 				"0.5", 					"PUMPS Time Between shots", 		DEFAULT_FLAGS);
	cvar_show_damage_pistol_time				= AutoExecConfig_CreateConVar("show_damage_pistol_time", 			"0.5", 					"PISTOLS Time Between shots", 		DEFAULT_FLAGS);
...
public Action Event_PlayerHurt(Handle event, char[] name, bool dontBroadcast)
{
	if(B_active_show_damage)
	{
		...
		if(Client_IsIngame(attacker) && Client_IsIngame(victim))
		{
			...
			|| StrEqual(S_weapon, "m4a1_silencer", false)
			...
			|| StrEqual(S_weapon, "revolver", false)
			) 
			{
...
public void LoadSettings()
{
	...
	BuildPath(Path_SM, hc, sizeof(hc), "configs/show_damage.cfg");
